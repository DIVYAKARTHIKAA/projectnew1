  ...
  render() {
    ...
    <div id="main-registration-container3">
     ...
     <div id="register3">
        ...
        <Link to='/patientrecord'><input id='t3' type="submit" className="button"  value="Register"/></Link>
        </form>
        <h4>Already have an Account?   <Link to='/Login'>Login here </Link></h4>
    </div>
</div>

<h1 className='p3'> GET YOUR OWN MEDICAL</h1>

<h1 className='pa3'>RECORD. JOIN FREE NOW</h1>
</div>
</>
      );
  }
